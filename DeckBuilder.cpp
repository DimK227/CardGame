...
list<BlackCard *> *DeckBuilder::get_black()
{
	return black;
}

list<GreenCard *> *DeckBuilder::get_green()
{
	return green;
}
...
GreenCard& DeckBuilder::getFateCard()
{
	GreenCard *gc;
	gc=(green->front());
	green->pop_front();
...
BlackCard& DeckBuilder::getDynastyCard()
{
	BlackCard *bc;
	bc=(black->front());
	black->pop_front();
